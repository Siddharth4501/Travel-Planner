...
const API_KEY = "748280a0e8a3a9eff530f5a4a7179e1b"; // API key for OpenWeatherMap API
...
const getWeatherDetails = (cityName, lat, lon) => {
    ...
    fetch(WEATHER_API_URL).then(res => res.json()).then(data => {
        ...
        fiveDaysForecast.forEach((weatherItem, index) => {
            ...
            if (index === 0) {
                currentWeatherDiv.insertAdjacentHTML("beforeend", createWeatherCard(cityName,weatherItem));
            } else {
